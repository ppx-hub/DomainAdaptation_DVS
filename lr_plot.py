...
parser.add_argument('--output', default='/home/hexiang/TransferLearning_For_DVS/Results/', type=str, metavar='PATH',
...
parser.add_argument('--no-domainLoss', action='store_true',
                    help='without domain loss')
parser.add_argument('--no-semanticLoss', action='store_true',
                    help='without semantic loss')
...
def main():
    ...
    if args.local_rank == 0:
        ...
        exp_name = '-'.join([
            ...
            "no_domainLoss_{}".format(args.no_domainLoss),
            "no_semanticLoss_{}".format(args.no_semanticLoss),
        ...
        output_dir = get_outdir(output_base, 'train_TCKA_refined', exp_name)
...
def train_epoch(
        epoch, model, source_loader, target_loader, optimizer, loss_fn, args, lr_scheduler=None, saver=None,
        output_dir='', amp_autocast=suppress, loss_scaler=None, model_ema=None, mixup_fn=None):
